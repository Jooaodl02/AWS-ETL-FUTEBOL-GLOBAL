...
JOB_NAME = "shootouts_names_job"
SOURCE_S3_PATH = "s3://bucket-futebol/raw/shootouts/shootouts.csv"
TARGET_S3_PATH = "s3://bucket-futebol/processed/shootouts/"
...
def transform_former_names(df: DataFrame, input_format: str, output_format: str) -> DataFrame:
    return (
        ...
        .withColumnRenamed("winner", "time_vencedor_penalti")
        .withColumnRenamed("first_shooter", "time_primeiro_a_bater_penalti")
    )
